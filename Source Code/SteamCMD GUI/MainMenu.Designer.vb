...
Partial Class MainMenu
    ...
    Friend WithEvents RunTab As TabPage
    Friend WithEvents GroupBox6 As GroupBox
    Friend WithEvents AddButton As Button
    Friend WithEvents SaveButton As Button
    Friend WithEvents InsecureCheckBox As CheckBox
    Friend WithEvents DevModeCheckBox As CheckBox
    Friend WithEvents RunServerButton As Button
    Friend WithEvents BotsCheckBox As CheckBox
    Friend WithEvents SourceTVCheckBox As CheckBox
    Friend WithEvents DebugModeCheckBox As CheckBox
    Friend WithEvents UDPPortTexBox As NumericUpDown
    Friend WithEvents RconTextBox As MaskedTextBox
    Friend WithEvents Label11 As Label
    Friend WithEvents Label10 As Label
    Friend WithEvents NetworkComboBox As ComboBox
    Friend WithEvents ServerNameTextBox As TextBox
    Friend WithEvents Label7 As Label
    Friend WithEvents MaxPlayersTexBox As NumericUpDown
    Friend WithEvents ModHelpButton As Button
    Friend WithEvents CustomModTextBox As TextBox
    Friend WithEvents ModList As ComboBox
    Friend WithEvents CustomModCheckBox As CheckBox
    Friend WithEvents MapList As ComboBox
    ...
    Friend WithEvents ExeBrowserButton As Button
    Friend WithEvents ExePath As TextBox
    Friend WithEvents Label4 As Label
    Friend WithEvents GroupBox2 As GroupBox
    Friend WithEvents AddCustomGameButton As Button
    Friend WithEvents ValidateCheckBox As CheckBox
    Friend WithEvents IdHelpButton As Button
    ...
    Friend WithEvents AnonymousCheckBox As CheckBox
    Friend WithEvents Label1 As Label
    Friend WithEvents UsernameTextBox As TextBox
    Friend WithEvents PasswordTextBox As MaskedTextBox
    Friend WithEvents GamesList As ComboBox
    Friend WithEvents GoldSrcModLabel As Label
    Friend WithEvents GoldSrcModInput As TextBox
